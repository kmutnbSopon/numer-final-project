    ...
    render() {
        return (
            <div style={{ background: "#FFFF", padding: "30px" }}>
                ...
                <Card
                    bordered={true}
                    style={{ width: "100%", background: "#001529", color: "#FFFFFFFF", float: "left", zIndex: "1" }}
                ...
                {this.state.showGraph &&
                    <Card
                        title={"Output of Bisection"}
                        bordered={true}
                        style={{ width: "100%", height: "75vmin", border: "#778899", background: "#001529", color: "#FFFFFFFF", float: "left", zIndex: "3" }}
                    >
                        <Plot
                            data={[
                                {
                ...
                {this.state.showOutputCard &&
                    <Card
                        bordered={true}
                        id="outputCard"
                        style={{ width: "100%", background: "#778899", color: "#FFFFFFFF", float: "inline-start", marginBlockStart: "2%", zIndex: "2" }}
                    >
