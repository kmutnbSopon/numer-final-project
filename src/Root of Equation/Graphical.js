        ...
        return (
            <div style={{ background: "#FFFF", padding: "30px" }}>
                ...
                <div>
                    <Card
                        bordered={true}
                        style={{ width: "100%", background: "#001529", color: "#FFFFFFFF", float: "left" }}
                    ...
                    {this.state.showGraph &&
                        <Card
                            title={"Output of Graphical"}
                            bordered={true}
                            style={{ width: "100%", height: "75vmin", border: "2px solid black", background: "#f44aaa6", color: "#FFFFFFFF", float: "left", zIndex: "3" }}
                        >
                            <Plot
                                data={[
                                    {
                    ...
                    {this.state.showOutputCard &&
                        <Card
                            title={"Output"}
                            bordered={true}
                            style={{ width: "100%", background: "#778899", color: "#FFFFFFFF", float: "outline-start", marginBlockStart: "2%", zIndex: "2" }}
                            id="outputCard"
                        >
